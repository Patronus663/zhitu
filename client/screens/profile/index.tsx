          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <TouchableOpacity style={styles.loginBtn} onPress={() => router.push('/login')}>
                <FontAwesome6 name="right-to-bracket" size={14} color="#3A5B7D" />
...
const styles = StyleSheet.create({
  ...
  accountEmail: { color: '#4A5A70', fontSize: 15, fontWeight: '600' },
  accountHint: { color: '#5A6B82', fontSize: 14, fontWeight: '600' },
  loginBtn: { backgroundColor: '#C5D6E8', borderRadius: 10, paddingHorizontal: 16, paddingVertical: 9 },
  loginBtnText: { color: '#3A5B7D', fontSize: 14, fontWeight: '600' },
  logoutBtn: { backgroundColor: '#C5D6E8', borderRadius: 10, paddingHorizontal: 16, paddingVertical: 9 },
  logoutBtnText: { color: '#3A5B7D', fontSize: 14, fontWeight: '600' },
