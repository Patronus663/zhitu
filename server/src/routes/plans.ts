...
// GET /api/v1/plans/items/:item_id - Get single plan item
...
// PUT /api/v1/plans/items/:item_id - Edit task
...
// DELETE /api/v1/plans/items/:item_id - Delete task
...
// PUT /api/v1/plans/items/:item_id/reschedule - Move task to another date
router.put('/items/:item_id/reschedule', async (req, res) => {
  try {
